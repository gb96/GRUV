...
ap.add_argument('-m', '--model', help='Model to work with',
                default=config['model_basename'])
ap.add_argument('-o', '--output', help='Output file location',
...
seed_len = 3
seed_seq = seed_generator.generate_copy_seed_sequence(
...
parse_files.save_generated_example(output_filename, output,
